...
import { thumbnailStyles, type ThumbnailStyle } from '../assests/assets/assets';
import { ImageIcon, SquareIcon,  SparkleIcon, PenToolIcon, CpuIcon, ChevronDownIcon } from 'lucide-react';
import { div } from 'motion/react-client';

const StyleSelector = ({value, onChange, isOpen , setIsOpen} : {value:ThumbnailStyle ; onChange: (value: string) => void;
    isOpen : boolean ; setIsOpen : (open : boolean) =>void
} ) =>
     {
      const  styleDescriptions : Record<ThumbnailStyle,string>={
        "Bold & Graphic" : "High Contrast , Bold TypoGraphy , Strinking Visuals",
        "Minimalist" : "Clean, simple , lots of white spaces",
        "Photorealistic" : "Photo Based , Nature Looking",
        "Illustrative" : "Just Put the ideas of your Mind",
