...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Testimonials" text2="Loved By the Creators" text3="See How our AI thumbnail Generator is helping the creators to explode with their content" />
