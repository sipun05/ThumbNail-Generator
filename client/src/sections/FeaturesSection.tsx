...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why Use Our Generator?" text3="Create Stunning ThumbNails that get the clicks , without the hassle " />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        <img className="h-full w-auto" src="src/assests/assets/thumb_2.jpg" alt="features showcase" width={1000} height={500} />
                    </motion.div>
                    ...
                    >
                        <img src="src/assests/assets/thumb_4.jpg" alt="features showcase" width={1000} height={500} className="hover:-translate-y-0.5 transition duration-300" />
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost Your Views with the AI optimized designs </h3>
                        <p className="text-slate-300 mt-2">Stop Guessing and start the ranking.Our AI creates designs proven to capture attention</p>
                        <a href="https://prebuiltui.com" className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition">
                            Start Generating for the Free.
